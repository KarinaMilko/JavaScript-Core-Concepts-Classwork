...
console.log("square1.getAria() :>> ", square1.getAria()); // square1.getAria() :>>  16
console.log("square1.name :>> ", square1.name); // square1.name :>>  square
...
console.log("rectangle1.getArea() :>> ", rectangle1.getAria()); // rectangle1.getArea() :>>  20
console.log("rectangle1.name :>> ", rectangle1.name); // rectangle1.name :>>  rectangle
...
console.log("calcAria(rectangle1) :>> ", calcAria(rectangle1)); // calcAria(rectangle1) :>>  20
